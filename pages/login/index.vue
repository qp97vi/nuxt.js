    ...
    <div class="m-login" style="background-color: #bf1919" id="divMLogin">
      <div class="login-wrap">
        ...
        <div class="login-form">
          <div class="title oh">
            <h1 class="fl" v-if="$store.state.shop_config">
              {{ i18n.title }}{{ shop_config.store_name }}
            </h1>
          ...
          <dl class="account">
            ...
            <a
              v-if="google.google_login_enable == '1'"
              href="javascript:void(0);"
              id="customBtn"
              >Google</a
            >&nbsp;&nbsp;
            <a
              v-if="facebook.facebook_login_enable == '1'"
              href="javascript:void(0);"
              id="sbfacebookBtn"
              @click="fbLogin"
